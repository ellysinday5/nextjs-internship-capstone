...
export function ListTab({
  ...
  return (
    <div className="flex-1 overflow-auto">
      {/* Table Header */}
      <div className="grid grid-cols-[1fr_180px_140px_120px_120px] border-b border-slate-200 dark:border-slate-800 text-[11px] font-semibold text-slate-400 px-6 py-1.5 bg-slate-50/30 dark:bg-[#0f1d31]/30">
        <div>Name</div>
        <div>Assignee</div>
        <div>Due date</div>
        <div>Priority</div>
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800/40">
              {section.tasks.map((task) => (
                <div
                  ...
                  className={`grid grid-cols-[1fr_180px_140px_120px_120px] items-center px-6 py-1.5 hover:bg-sky-50/50 dark:hover:bg-sky-950/20 cursor-pointer text-xs transition-colors ${
