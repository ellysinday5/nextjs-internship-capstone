        ...
        <div className="sm:col-span-2 space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-medium text-slate-400 dark:text-slate-500">
              <Lock size={11} /> Auto-derived from active workspace
            </span>
          </div>
          <div className="relative">
            <input
              ...
              readOnly
              disabled
              className="w-full px-3.5 py-2.5 border border-slate-200 dark:border-slate-700/80 rounded-xl bg-slate-50/80 dark:bg-slate-800/50 text-slate-600 dark:text-slate-300 text-sm font-semibold cursor-not-allowed select-none"
            />
          </div>
        </div>
      </div>
