...
export type SortOption = 
  | "default" | "name" | "priority" | "assignee" | "dueDate";
...
export function useTaskFilters(resolvedProjectId: string | null, sections: Section[]) {
  ...
  return {
    ...
    sortBy, setSortBy,
    showClosedTasks, setShowClosedTasks,
    autosaveEnabled, handleEnableAutosave,
    savedView, handleSaveView, handleSaveAsNewView, handleRevertClosedTasks,
    filteredSections
  };
}
