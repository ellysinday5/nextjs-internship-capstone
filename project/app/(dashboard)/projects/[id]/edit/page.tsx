...
import { initialProjects, ProjectItem } from "@/lib/project-data";
...
export default function EditProjectPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Shared label class
  const label = "text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block mb-2";
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <Pencil size={14} className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
                </div>
                {formError && <p className="mt-1.5 text-xs font-medium text-red-500">{formError}</p>}
              </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <ChevronDown size={14} className="absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none opacity-60" />
                </div>
              </div>
